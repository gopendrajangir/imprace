...
interface StandardInterviewFormProps {
  onStart: (info: CandidateInfo) => void;
}

export const StandardInterviewForm: React.FC<StandardInterviewFormProps> = ({
  onStart,
}) => {
  ...
  // Resume (PDF) — parsed text is stored and folded into userInfo.
      ...
      >
        ...
        >
          {isParsingResume ? (
            ...
            <>
              <Icon source="file-check-outline" size={22} color={theme.gold} />
              <Text
